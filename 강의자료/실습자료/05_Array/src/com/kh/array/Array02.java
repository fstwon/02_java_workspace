...
public class Array02 {
	 ...
	 *     
	 * * 배열 특징
	 *   - 배열 선언 및 할당까지만 한 후 직접 초기화하지 않아도 기본적으로 값들이 저장됨!
	...
	public static void main(String[] args) {
		...
		/*
		 * 연결이 끊어진 기존 배열은 Heap 영역에서 둥둥 떠다님...
		 * ( 어디에도 참조되지 않고 있어, 필요없는 존재가 됨! )
		 * => 일정 시간이 지나면 "가비지 컬렉터(GC)"가 알아서 제거해줌!
		 * => 자바에서의 "자동 메모리 관리" 특징 -> 개발자는 코드 작성에만 집중할 수 있음!
		 */
