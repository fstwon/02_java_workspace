...
public class API3_Wrapper {
	...
	public static void main(String[] args) {
		...
		// System.out.println( n1.equals(n2) );  // x
		...
		System.out.println(str1 + str2);	// 10 + 33.5 => 43.5? xx
											// "10" + "33.5" => "1033.5"
		
		// * Wrapper클래스.parseXXX()
		int num = Integer.parseInt(str1);	// "10" -> 10
		double dNum = Double.parseDouble(str2);	// "33.5" -> 33.5
