...
public class Run {
	 ...
	 *      2) 공통적인 속성 및 기능
	 *         -> 이름, 나이, 키, 몸무게, 주소, 연락처, 학원에간다, 밥을먹는다, 잠을잔다, 공부한다, ...
	 ...
	 *    		김일현 학생 객체를 하나 만들기 -> String name2 = "김일현"; int age2 = 20; double height2 = 174.8;
	...
	public static void main(String[] args) {
		...
		// * 변수 선언 : 클래스명 참조변수명;
		Student std1;	// 선언만 하면 변수는 null 값을 가지고 있을 것임!
