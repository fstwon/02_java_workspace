...
public class Run {
	 ...
	 *   
	 *   * 왜 예외처리를 하는가? (목적)
	 *    : 예외처리를 하지 않을 경우 프로그램이 비정상적으로 종료될 수 있기때문에,
	...
	public static void method3() {
		// 나만의 예외 만들기 => 예외 발생 시키기
		// [1] 예외 클래스 정의하기 => MyException 클래스 추가
		// [2] 예외 발생 시키기 => throw new MyException();
		try {
			// => 예외가 발생됨 --> 예외처리를 해야함!!
			// throw new MyException();
			throw new MyException("내가 만든 예외가 발생됩니다...");
	...
	public static void method2() {
		 ...
		 * => 조건문 사용 불가 : 예측이 불가능한 곳에서 문제가 발생되기 때문에 예외처리를 해야함!
		 * =>				  외부 매체와의 입출력 시 발생됨!! 
		 */
	...
	public static void method1() {
		/*
		 * Unchecked Exception
		 * : 예외처리가 필수는 아니나 실행 중 발생 가능성이 있는 예외(오류)!!
		 */
